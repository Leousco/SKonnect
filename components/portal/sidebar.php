<aside class="sidebar">
    ...
    <nav class="sidebar-nav" aria-label="Main navigation">
        <ul>
            ...
            <li class="<?= basename($_SERVER['PHP_SELF']) == 'feed_page.php' ? 'active' : '' ?>">
            ...
            <li class="<?= basename($_SERVER['PHP_SELF']) == 'services_page.php' ? 'active' : '' ?>">
            ...
            <li class="<?= basename($_SERVER['PHP_SELF']) == 'notifications_page.php' ? 'active' : '' ?>">
            ...
            <li class="<?= basename($_SERVER['PHP_SELF']) == 'profile_page.php' ? 'active' : '' ?>">
